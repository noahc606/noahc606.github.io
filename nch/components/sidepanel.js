class NCH_SidePanel extends HTMLElement {
    ...
    connectedCallback() {
        this.innerHTML = `
        <div class="sidepanel">
            <a href="#" onclick="spBtnClick()" onmouseover="spBtnHover()" onmouseleave="spBtnLeave()" class="sidepanel-toggle">
                <img id="sidepanel-btn-img" src="images/sidebar-btn-light.png" alt="Sidepanel Toggle Button">
            </a>
            
            <div class="sidepanel-navbar-holder" id="sidepanel-navbar-holder">
